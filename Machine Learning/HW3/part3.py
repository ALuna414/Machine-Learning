...
combined_data_lab = pd.DataFrame()
...
combined_data_main = pd.DataFrame()
...
####################################################
pipe_lr = make_pipeline(StandardScaler(), PCA(n_components=2), DecisionTreeClassifier())
pipe_lr.fit(X_train, y_train)
y_pred = pipe_lr.predict(X_test)
print('Test Accuracy: %.3f' % pipe_lr.score(X_test, y_test))
pipe_lr = Pipeline([('standardscaler', StandardScaler()),('pca', PCA()),('tree', DecisionTreeClassifier())])
param_grid = {
...
pipe_lr2 = make_pipeline(StandardScaler(), LDA(n_components=3), DecisionTreeClassifier())
pipe_lr2.fit(X_train, y_train)
y_pred2 = pipe_lr2.predict(X_test)
print('Test Accuracy2: %.3f' % pipe_lr2.score(X_test, y_test))
pipe_lr2 = Pipeline([('standardscaler', StandardScaler()),('LDA', LDA()),('tree', DecisionTreeClassifier())])
param_grid2 = {
...
pipe_lr3 = make_pipeline(StandardScaler(), KernelPCA(n_components=2, kernel='rbf', gamma=15), DecisionTreeClassifier())
pipe_lr3.fit(X_train, y_train)
y_pred3 = pipe_lr3.predict(X_test)
print('Test Accuracy3: %.3f' % pipe_lr3.score(X_test, y_test))
pipe_lr3 = Pipeline([('standardscaler', StandardScaler()),('KPCA', KernelPCA(kernel='rbf')),('tree', DecisionTreeClassifier())])
param_grid3 = {
...
pipe_lr4 = make_pipeline(MinMaxScaler(), PCA(n_components=2), DecisionTreeClassifier())
pipe_lr4.fit(X_train, y_train)
y_pred4 = pipe_lr4.predict(X_test)
print('Test Accuracy4: %.3f' % pipe_lr4.score(X_test, y_test))
pipe_lr4 = Pipeline([('standardscaler', StandardScaler()),('pca', PCA()),('tree', DecisionTreeClassifier())])
param_grid4 = {
    'pca__n_components': [1, 2, 3],  # Number of components for PCA
    'tree__criterion': ['gini', 'entropy'],  
    'tree__max_depth': [None, 10, 20, 30],  
...
pipe_lr5 = make_pipeline(MinMaxScaler(), LDA(n_components=1), DecisionTreeClassifier())
pipe_lr5.fit(X_train, y_train)
y_pred5 = pipe_lr5.predict(X_test)
print('Test Accuracy5: %.3f' % pipe_lr5.score(X_test, y_test))
pipe_lr5 = Pipeline([('standardscaler', StandardScaler()),('LDA', LDA()),('tree', DecisionTreeClassifier())])
param_grid5 = {
    'LDA__n_components': [1, 2, 3],  # Number of components for PCA
    'tree__criterion': ['gini', 'entropy'],  
    'tree__max_depth': [None, 10, 20, 30],  
...
pipe_lr6 = make_pipeline(MinMaxScaler(), KernelPCA(n_components=3, kernel='rbf', gamma=15), DecisionTreeClassifier())
pipe_lr6.fit(X_train, y_train)
y_pred6 = pipe_lr6.predict(X_test)
print('Test Accuracy6: %.3f' % pipe_lr6.score(X_test, y_test))
pipe_lr6 = Pipeline([('standardscaler', StandardScaler()),('KPCA', KernelPCA(kernel='rbf')),('tree', DecisionTreeClassifier())])
param_grid6 = {
    'KPCA__n_components': [1, 2, 3],  # Number of components for PCA
    'tree__criterion': ['gini', 'entropy'],  
    'tree__max_depth': [None, 10, 20, 30],  
...
####################################################
def plot_decision_regions(X,y,classifier=tree,test_idx=None,resolution=0.02):  #forest  knn
...
plt.savefig('Part3_CM_train_results.png')
plt.show() 
plt.close()
...
plt.savefig('Part3_CM_test_results.png')
plt.show() 
plt.close()
####################################################
